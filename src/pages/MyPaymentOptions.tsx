    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            {savedMethods.map((method) => (
              <div
                ...
                className={`border rounded-lg p-4 transition-all ${
                  method.isDefault ? 'border-violet-600 bg-violet-50' : 'border-gray-200'
                }`}
              >
                  ...
                  <div className="flex items-center gap-3">
                    {method.type === 'card' ? (
                      <CreditCard className={`w-6 h-6 ${
                        method.isDefault ? 'text-violet-600' : 'text-gray-600'
                      }`} />
                    ) : (
          ...
          <button className="mt-6 w-full flex items-center justify-center gap-2 py-3 px-4 border-2 border-dashed border-gray-300 rounded-lg text-gray-600 hover:text-violet-600 hover:border-violet-600 transition-colors">
